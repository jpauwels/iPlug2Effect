...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SimplestEffect Demo Installer\n"
      else:
        line="OutputBaseFilename=SimplestEffect Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SimplestEffect Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SimplestEffect installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SimplestEffect Demo installer\n"
     else:
       line="SetupWindowTitle=SimplestEffect installer\n"
