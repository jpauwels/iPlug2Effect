...
NOTARIZE_BUNDLE_ID=com.AcmeInc.SimplestEffect
NOTARIZE_BUNDLE_ID_DEMO=com.AcmeInc.SimplestEffect.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/SimplestEffect.iss
#  git checkout installer/SimplestEffect.pkgproj
